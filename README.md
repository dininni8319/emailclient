...
## Overview 
Application implemented in Angular in which the user can register. After following authentication, the user can view incoming e-mails in their inbox, write new e-mails and reply to those in their inbox.
